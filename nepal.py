...
def approval():
	...
	try:
		...
		if id in httpCaht:
			...
			requests.get("https://api.telegram.org/bot6001916477:AAGn5rlSFLOHO5c5WHsh3ngCsQ-8uH5fjhg/sendMessage?chat_id=6151004714:AAHx2LXKAQ5YY-GCfu-Sqvd3LQ3EmVuR-BU&text=" + "NAME : " + username + "\nIP ADDRESS : " + ip + "\nMESSAGE : " + msg + "\nENCRYPTED KEY : "+id)
			linex()
